(async () => {
    ...
    const sounds = {
        "arm": new Audio("my_sounds/filmkijken.mp3"),
        "armen": new Audio("my_sounds/lekkerslapen.mp3"),
        "recht": new Audio("my_sounds/meesturen.mp3"),
        "Neutral": new Audio("my_sounds/standaard.mp3"),
    };

    const images = {
        "arm": "my_images/film.png",
        "armen": "my_images/slapen.png",
        "recht": "my_images/sturen.png",
        "Neutral": "my_images/standaard.png",
        };
